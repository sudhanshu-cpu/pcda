...
function myCreateFunction(detail) {
	...
	if (detail == 'hotelAddmore') {
		if (validateLeaveDetails() && valideteHotelDetails()) {
			...
			cell10.setAttribute("width", "85px;");
			...
			innerHtmlValue = '';
			innerHtmlValue = '<input type="text" name="hotelName" id="hotelName' + hotelTableIdlen + '"   class="txtfldM" size="15" maxlength="50" autocomplete="off"/>';
			cell2.innerHTML = innerHtmlValue;

			innerHtmlValue = '';
			innerHtmlValue = '<div>'
			innerHtmlValue = innerHtmlValue + '<input type="text"   name="hotelCity" id="hotelCity' + hotelTableIdlen + '"  onkeyup="fetchCityList(' + hotelTableIdlen + ',this)" class="txtfldM" style="width:80%" size="7" autocomplete="off" onblur="fillCity(\'\',\'\',\'' + hotelTableIdlen + '\')"/>';
			...
			innerHtmlValue = '';
			innerHtmlValue = '<input type="text"  name="hotelGSTNo" id="hotelGSTNo' + hotelTableIdlen + '" size="12" class="txtfldM" maxlength="20" autocomplete="off"/>';
			...
			innerHtmlValue = '';
			innerHtmlValue = '';
			innerHtmlValue = '<input type="text"  name="hotelNoDays" id="hotelNoDays' + hotelTableIdlen + '"  size="4" class="txtfldM" onkeypress="return isNumericOnlyKey(event)" onblur="validateHotelDays(' + hotelTableIdlen + ');" maxlength="4" autocomplete="off"/>';
			...
			innerHtmlValue = innerHtmlValue + '<input type="text" name="hotelAmount" id="hotelAmount' + hotelTableIdlen + '" onkeypress="return isNumberKey(event)"  onblur="getAmount(1,' + hotelTableIdlen + ');" size="7" class="txtfldM" style="width:80%" maxlength="7" autocomplete="off"/><input type="hidden" name="actualHotelAmount" id="actualHotelAmount' + hotelTableIdlen + '"/></td>';
			cell8.innerHTML = innerHtmlValue;

			innerHtmlValue = '';
			innerHtmlValue = innerHtmlValue + '<input type="text" name="hotelGSTAmount" id="hotelGSTAmount' + hotelTableIdlen + '" value="0" onkeypress="return isNumberKey(event)"  size="7" class="txtfldM" maxlength="7" autocomplete="off"/></td>';
			...
			$('#checkInDate' + hotelTableIdlen).datetimepicker({
				lang: 'en', scrollMonth: false, timepicker: true, format: 'd-m-Y H:i', formatDate: 'd-m-Y', maxDate: 0, step: 5, disabledDates: getLeaveDates(),
		...
		onShow: function () {
			...
			$('#checkOutDate' + hotelTableIdlen).datetimepicker({
				lang: 'en', scrollMonth: false, timepicker: true, format: 'd-m-Y H:i', formatDate: 'd-m-Y', maxDate: 0, step: 5, disabledDates: getLeaveDates(),
		...
		if (validateLeaveDetails() && valideteFoodDetails()) {
			...
			if (0 == foodTableIdlen || !validFoodHeaderFlag) {
				...
				if ($("#userServiceType").val() == '1') {
					...
					var innerHtmlValue = '';
					innerHtmlValue = '<td ><input type="text" name="foodNoDay" id="foodNoDay' + foodTableIdlen + '"  class="txtfldM" size="10" style="width:50%" maxlength="5" onkeypress="return isNumericOnlyKey(event)"  onblur="calculateFoodAmount(' + foodTableIdlen + ');" autocomplete="off"/></td>';
					cell2.innerHTML = innerHtmlValue;

					innerHtmlValue = '';
					innerHtmlValue = innerHtmlValue + '<td ><input type="text" name="foodAmount" id="foodAmount' + foodTableIdlen + '" onkeypress="return isNumberKey(event)" class="txtfldM"  style="width:50%" size="10" maxlength="10" onblur="validateFoodAmount(' + foodTableIdlen + ');" autocomplete="off"/><input type="hidden" name="actualFoodAmount" id="actualFoodAmount' + foodTableIdlen + '"/></td>';
					cell3.innerHTML = innerHtmlValue;
					...
					var innerHtmlValue = '';
					innerHtmlValue = '<select name="nonDrawlCertificate" id="nonDrawlCertificate' + foodTableIdlen + '" style="width:80%;" class="combo"><option value="">Select</option><option value="0">Yes</option><option value="1">No</option></select>';
					cell1.innerHTML = innerHtmlValue;
	...
	if (detail == 'tourAddmore') {
		if (validateLeaveDetails() && valideteTourDetails()) {
			...
			if ($("#is_conveyanceDtls").val() == 0) {
				...
				var innerHtmlValue = '';
				innerHtmlValue = '<td ><input type="text" name="tourVehicleNo" id="tourVehicleNo' + tourTableIdlen + '"  class="txtfldM" style="width:80%" size="20" maxlength="20" autocomplete="off"/></td>';
				cell1.innerHTML = innerHtmlValue;

				innerHtmlValue = '';
				innerHtmlValue = '<td ><input type="text" readonly="true" name="tourDate" id="tourDate' + tourTableIdlen + '" class="txtfldM" style="width:80%" size="12" maxlength="20" autocomplete="off"/></td>';
				cell2.innerHTML = innerHtmlValue;

				innerHtmlValue = '';
				innerHtmlValue = '<td ><input type="text" name="tourDistance" id="tourDistance' + tourTableIdlen + '" class="txtfldM" size="8" style="width:80%" maxlength="10" onkeypress="return isNumericOnlyKey(event)" autocomplete="off"/></td>';
				cell3.innerHTML = innerHtmlValue;

				innerHtmlValue = '';
				innerHtmlValue = '<td ><input type="text" name="tourBillNo" id="tourBillNo' + tourTableIdlen + '" class="txtfldM" size="10" style="width:80%" maxlength="30" autocomplete="off"/></td>';
				cell4.innerHTML = innerHtmlValue;


				innerHtmlValue = '';
				innerHtmlValue = innerHtmlValue + '<td ><input type="text" name="tourAmount" id="tourAmount' + tourTableIdlen + '" onkeypress="return isNumberKey(event)" onblur="getAmount(3,' + tourTableIdlen + ');" class="txtfldM" size="10" style="width:80%" maxlength="10" autocomplete="off"/><input type="hidden" name="actualTourAmount" id="actualTourAmount' + tourTableIdlen + '"/></td>';
				cell5.innerHTML = innerHtmlValue;
				...
				$("#tourDate" + tourTableIdlen).datetimepicker({
					lang: 'en', scrollMonth: false, timepicker: false, format: 'd-m-Y', formatDate: 'd-m-Y', maxDate: 0, disabledDates: getLeaveDates(),
		...
		onShow: function () {
			  $("#tourDate" + tourTableIdlen).val("");
				...
				if (0 == tourTableIdlen || !validTourHeaderFlag) {
					...
					cell10.innerHTML = "<b>Number of Days</b>";
					cell20.innerHTML = "<b>Amount</b>";
					cell30.innerHTML = "";
	...
	if (detail == 'taAddmore') {
		...
		if (validateLeaveDetails() && valideteTADetails()) {
			...
			innerHtmlValue = '';
			innerHtmlValue = '<td><select name="nonDTSClassOfTravel" id="nonDTSClassOfTravel' + taTableIdlen + '" class="combo"  style="width:135px;"><option value="">Select</option></select></td>';
			cell4.innerHTML = innerHtmlValue;

			innerHtmlValue = '';
			innerHtmlValue = '<td><input type="text"   name="nonDTSJryStartDate" id="nonDTSJryStartDate' + taTableIdlen + '" size="10" class="txtfldM" style="width:85%" readonly="true" autocomplete="off"/></td>';
			cell5.innerHTML = innerHtmlValue;

			innerHtmlValue = '';
			innerHtmlValue = '<td><input type="text" name="nonDTSJryEndDate" id="nonDTSJryEndDate' + taTableIdlen + '" class="txtfldM" size="16" maxlength="20"  style="width:95%" readonly="true" autocomplete="off"/></td>';
			cell6.innerHTML = innerHtmlValue;
			...
			$('#nonDTSJryStartDate' + taTableIdlen).datetimepicker({
				lang: 'en', scrollMonth: false, timepicker: true, format: 'd-m-Y H:i', formatDate: 'd-m-Y', maxDate: 0, step: 5, disabledDates: getLeaveDates(),
		...
		onShow: function () {
			...
			$('#nonDTSJryEndDate' + taTableIdlen).datetimepicker({
				lang: 'en', scrollMonth: false, timepicker: true, format: 'd-m-Y H:i', formatDate: 'd-m-Y', maxDate: 0, step: 5, disabledDates: getLeaveDates(),
				scrollInput:false,yearEnd : 2100,defaultDate: $("#travel_Start_Date").val(), onSelectTime: function(current_time, $input) { validateDate(6, taTableIdlen); },
		onShow: function () {
	...
	if (detail == 'leavePeriodAddmore') {
		if (valideteLeavePeriodDetails()) {
			...
			if (0 == leaveTableIdlen || !validLeaveHeaderFlag) {
				...
				row0.className = "lablevaluebg";
				var cell10 = row0.insertCell(0);
				cell10.setAttribute("width", "50px;");
				cell10.className="lablevalue";
				var cell20 = row0.insertCell(1);
			...
			innerHtmlValue = '<td><input type="text"   id="leavePeriodDate' + leaveTableIdlen + '" size="11" class="txtfldM" readonly="true" autocomplete="off"/></td>';
			cell1.innerHTML = innerHtmlValue;
			...
			$('#leavePeriodDate' + leaveTableIdlen).datetimepicker({
				lang: 'en', scrollMonth: false, timepicker: false, format: 'd-m-Y', formatDate: 'd-m-Y', maxDate: 0, disabledDates: getSelfLeave(),
...
function validateHotelDays(index) {
	...
	if (Number(noOfDay) > Number(day)) {
		alert("Number of Days can not be greater than " + Number(day));
...
function validateSaveDetails(travelType) {
	...
	if (flag) {
		alert("Claim has been sent to CO for approval. A PDF of the Claim has also been sent to the email id of the traveler for information.");
...
function validateDate(type, index) {
	...
	if(dateOnwardToTime==1)
	 	{
	var fromDateSplit = dateFrom.split(' ');
    var frmHrTmSplit = fromDateSplit[1].split(':');
    var frmHour = parseInt(frmHrTmSplit[0]);
    var frmMin = parseInt(frmHrTmSplit[1]);

    var toDateSplit = dateTo.split(' ');
    var toHrTmSplit = toDateSplit[1].split(':');
    var toHour = parseInt(toHrTmSplit[0]);
    var toMin = parseInt(toHrTmSplit[1]);
			
				
		
		
			if(toHour<frmHour){
			alert("Journey End Date Hour cannot be less than Journey Start Date Hour.");			
			document.getElementById("nonDTSJryEndDate" + index).value='';
			return false;
			
			}else{ 
				if(toHour==frmHour && toMin<=frmMin){
				alert("Journey End Date Hour Min cannot be less than Journey Start Date Hour Min.");
...
function previewTADAClaimForm(travelType) {
	...
	if (flag) {
		...
		if (travelType == '100002') {
			...
			if (taTableIdlen.length > 0) {
				...
				for (var i = 0; i < taTableIdlen.length; i++) {
					...
					innerHTML = innerHTML + '<tr class="lablevaluebg"><td width="50px;">' + $("#nonDTSFromPlace" + val).val() + '</td>';
			...
			if (hotelTableIdlen.length > 0) {
				...
				innerHTML = innerHTML + 'Check In Date</td><td class="lablevalue" style="width:10%">Check Out Date</td><td class="lablevalue" style="width:10%">Number of Days</td>';
				innerHTML = innerHTML + '<td class="lablevalue" style="width:13%">Hotel Bill (Excluding GST)</td><td class="lablevalue" style="width:60px">GST Amt</td></tr>';
			...
			if (foodTableIdlen.length > 0) {
				...
				innerHTML = innerHTML + '<table class="filtersearch"><tbody class="all1">';
				innerHTML = innerHTML + '<tr class="lablevaluebg">';
				if($("#userServiceType").val() != '1'){
				innerHTML = innerHTML + '<td class="lablevalue" style="width:40%;"> Is the Non-drawl for Ration Certificate issued by the Quarter Master of the Parent Unit ?</td>';
				}
				...
				for (var i = 0; i < foodTableIdlen.length; i++) {
					...
					innerHTML = innerHTML + '<tr class="lablevaluebg"><td>' + $("#nonDrawlCertificate" + val + " option:selected").text() + '</td>';
					innerHTML = innerHTML + '<td>' + $("#foodNoDay" + val).val() + '</td>';
					innerHTML = innerHTML + '<td>' + $("#foodAmount" + val).val() + '</td></tr>';
			...
			if (tourTableIdlen.length > 0) {
				...
				if ($("#is_conveyanceDtls").val() == 0) {
					...
					for (var i = 0; i < tourTableIdlen.length; i++) {
						...
						innerHTML = innerHTML + '<tr class="lablevaluebg"><td>' + $("#tourVehicleNo" + val).val() + '</td>';
						innerHTML = innerHTML + '<td>' + $("#tourDate" + val).val() + '</td>';
						innerHTML = innerHTML + '<td>' + $("#tourDistance" + val).val() + '</td>';
						innerHTML = innerHTML + '<td>' + $("#tourBillNo" + val).val() + '</td>';
						innerHTML = innerHTML + '<td>' + $("#tourAmount" + val).val() + '</td></tr>';
					...
					for (var i = 0; i < tourTableIdlen.length; i++) {
						...
						innerHTML = innerHTML + '<tr class="lablevaluebg"><td width="25%;">' + $("#tourNoOfDays" + val).val() + '</td>';
						innerHTML = innerHTML + '<td width="15%;">' + $("#tourAmount" + val).val() + '</td></tr>';
			...
			innerHTML = innerHTML + '<table class="filtersearch"><tbody class="all1">';
			innerHTML = innerHTML + '<tr class="lablevalue"><td class="lablevalue">DA Advance from DTS</td><td class="lablevalue">Advance Drawn from PAO</td>';
			innerHTML = innerHTML + '<td class="lablevalue">Date of Advance Drawn from PAO</td><td class="lablevalue">Advance Drawn from Other Sources</td>';
			innerHTML = innerHTML + '<td class="lablevalue">Voucher No for Advance Drawn from Other Sources</td><td class="lablevalue">Date of Advance Drawn from Other Sources</td></tr>';
			...
			innerHTML = innerHTML + '<table class="filtersearch"><tbody class="all1">';
			innerHTML = innerHTML + '<tr class="lablevalue"><td class="lablevalue">eMRO/MRO/Refund Amount</td><td class="lablevalue">eMRO/MRO/Refund No</td>';
			innerHTML = innerHTML + '<td class="lablevalue">eMRO/MRO Submission Date/Refund  Date</td></tr>';
			...
			innerHTML = innerHTML + '<div class="welcomebox" style="margin-bottom:2px"><table class="filtersearch"><tbody class="all1">';
			innerHTML = innerHTML + '<tr class="lablevalue"><td class="lablevalue">Total Amount of Claim:&nbsp;&nbsp;' + $("#totalSpentAmount").val() + '</td></tr>';
			innerHTML = innerHTML + '<tr class="lablevalue"><td class="lablevalue">less: Advance Taken:&nbsp;&nbsp;' + $("#totalAdvanceAmount").val() + '</td></tr>';
			innerHTML = innerHTML + '<tr class="lablevalue"><td class="lablevalue">add: Refunds:&nbsp;&nbsp;' + $("#totalRefundAmount").val() + '</td></tr>';
			innerHTML = innerHTML + '<tr class="lablevalue"><td class="lablevalue">Payable/Recoverable Amount:&nbsp;&nbsp;' + $("#totalClaimedAmount").val() + '</td></tr></tbody></table></div>';
			...
			if (ltcJrnyTableIdlen.length > 0) {
				for (var i = 0; i < ltcJrnyTableIdlen.length; i++) {
					...
					innerHTML = innerHTML + '<table id="ltcNonDtsJrnyTableGrid" class="filtersearch" width="100%" cellspacing="0" cellpadding="0" border="0">';
					innerHTML = innerHTML + '<tr class="lablevalue"><td><table class="filtersearch width="100%" cellspacing="0" cellpadding="0"><tbody class="all1"><tr class="lablevalue">';
					innerHTML = innerHTML + '<td colspan="5" bgcolor="#AAAAAA" align="left"></td><td colspan="3" bgcolor="#AAAAAA" style="text-align:right">';
					innerHTML = innerHTML + 'Journey Type:' + $("#nonDTSJourneyType" + val + " option:selected").text() + '</td></tr>';
					...
					innerHTML = innerHTML + $("#nonDTSToPlace" + val).val() + '</td><td><b>Class of Accommodation</b></td><td>' + $("#nonDTSClassOfTravel" + val + " option:selected").text();
					...
					innerHTML = innerHTML + '</td></tr><tr><td colspan="10" style="text-align:right"></td></tr><tr><td style="padding:5px;" colspan="11" bgcolor="#003A70" align="left">';
			...
			if (ptJrnyTableIdlen.length > 0) {
				for (var i = 0; i < ptJrnyTableIdlen.length; i++) {
					...
					innerHTML = innerHTML + '<tr><td class="lablevalue">Mode of Travel</td><td>' + $("#nonDTSModeOfTravel" + val + " option:selected").text();
					innerHTML = innerHTML + '</td><td class="lablevalue">Departure Place</td><td>' + $("#nonDTSFromPlace" + val).val() + '</td><td class="lablevalue">Arrival Place</td><td>';
					innerHTML = innerHTML + $("#nonDTSToPlace" + val).val() + '</td><td class="lablevalue">Class of Accommodation</td><td>' + $("#nonDTSClassOfTravel" + val + " option:selected").text();
					innerHTML = innerHTML + '</td></tr><tr><td class="lablevalue">Departure Time</td><td>' + $("#nonDTSJryStartDate" + val).val();
					innerHTML = innerHTML + '</td><td class="lablevalue">Arrival Time</td><td>' + $("#nonDTSJryEndDate" + val).val() + '</td><td class="lablevalue">Sector</td><td>';
					innerHTML = innerHTML + $("#nonDTSSector" + val).val() + '</td><td class="lablevalue">Bill/PNR/ Ticket No.</td><td>' + $("#nonDTSTicketNo" + val).val();
					innerHTML = innerHTML + '</td></tr><tr><td class="lablevalue">Distance (KM)</td><td>' + $("#nonDTSDistanceKM" + val).val() + '</td><td class="lablevalue">Total Fare';
			...
			innerHTML = innerHTML + '<td style="width:20%;background-color:#EBF4FA;bordwer-right:1px solid white">Weight (in Kg)</td>';
			innerHTML = innerHTML + '<td style="width:20%;background-color:#EBF4FA;bordwer-right:1px solid white">Mode of Conveyance</td>';
			innerHTML = innerHTML + '<td style="width:20%;background-color:#EBF4FA;bordwer-right:1px solid white">Distance (in Kms)</td>';
			...
			if ($("#conveyancePartOfLuggage").val() == '1') {
				...
				innerHTML = innerHTML + '<td style="width:25%;background-color:#EBF4FA;bordwer-right:1px solid white">Mode of Conveyance</td>';
				innerHTML = innerHTML + '<td style="width:25%;background-color:#EBF4FA;bordwer-right:1px solid white">Distance (in Kms)</td>';
		...
		for (var i = 0; i < claimCertify.length; i++) {
			innerHTML = innerHTML + '<tr><td style="width:5%">' + (i + 1) + '</td><td style="width:95%">' + claimCertify[i].value + '</td></tr>';
		}
...
//					var path = encodeURIComponent(fileTypePath[i].value);
					...
					innerHTML = innerHTML + '<img src="' + $("#context_path").val() + 'images/pdfImage.png" style="width:25px;height:25px" alt=""></a></td>';
				}
				innerHTML = innerHTML + '</tr>';
			}
		...
		if ($("#userServiceType").val() == '1') {
			...
			innerHTML = innerHTML + '<td><span style="background-color: coral;">' + $("#counterPersonalName").val() + '</span></td>';
			innerHTML = innerHTML + '<td><span style="background-color: coral;">' + $("#counterPersonalLevel").val() + '</span></td></tr>';
		}
		...
		innerHTML = innerHTML + '<tr class="lablevalue"><td colspan="4">';
		innerHTML = innerHTML + 'If Date of Claim Preferred is more than 60 days from last date of Journey then whether time barred sanction taken?&nbsp;&nbsp;<span style="font-weight:normal">';
		innerHTML = innerHTML + $("#claimPreferredSanction option:selected").text() + '</span></td></tr>';
		innerHTML = innerHTML + '<tr class="lablevalue"><td>Sanction No:<span style="font-weight:normal">' + $("#claimPreferredSanctionNo").val() + '</span></td>';
		innerHTML = innerHTML + '<td colspan="3">Sanction Date:<span style="font-weight:normal">' + $("#claimPreferredSanctionDate").val() + '</span></td></tr></tbody></table></div>';
		...
		innerHTML = innerHTML + '<input type="button" value="Send to CO"  onclick="return validateSaveDetails(\'' + travelType + '\')" class="butn">';
...
function saveClaimAsDraft(travelType) {

	if (confirm("Are you sure that you want to save claim as draft?")) {
		...
		$('#voucherSettlementConfirmationForm').attr('action', $("#context_path").val() + 'mb/saveClaimAsDraft');
		$('#voucherSettlementConfirmationForm').submit();
...
function createLTCJrnyDetails() {
	...
	if (valideteLTCJrnyDetails()) {
		...
		cell0.innerHTML = '<div class="welcomecont"><table class="filtersearch" width="100%" cellpadding="0" cellspacing="0" id="nonDTSJrnyDetls' + ltcJrnyTableIdlen + '"><tbody class="all1"></tbody></table></div>';
		...
		var innerHtmlValue = '<table class="filtersearch" cellspacing="1" cellpadding="4" width="100%" border="0" id="nonDTSJrnyPassDetls' + ltcJrnyTableIdlen + '">';
		innerHtmlValue = innerHtmlValue + '<tbody class="all3">';
		...
		innerHtmlValue = innerHtmlValue + '<tr class="lablevalue">';
		innerHtmlValue = innerHtmlValue + '<td><select name="nonDTSPassDtlsTravellerName' + ltcJrnyTableIdlen + '" id="nonDTSPassDtlsTravellerName' + ltcJrnyTableIdlen + '_' + ltcJrnyPassTableIdlen + '" class="combo" style="width:90%;" onchange="setTravellerRelationAndAge(this.value,' + ltcJrnyTableIdlen + ',' + ltcJrnyPassTableIdlen + ');"><option value="">Select</option></td>';
		innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsRelation' + ltcJrnyTableIdlen + '" id="nonDTSPassDtlsRelation' + ltcJrnyTableIdlen + '_' + ltcJrnyPassTableIdlen + '" class="combo" style="width:80%;" onkeypress="return isNumberKey(event)" readonly="true"></td>';
		innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsAge' + ltcJrnyTableIdlen + '" id="nonDTSPassDtlsAge' + ltcJrnyTableIdlen + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="3" onkeypress="return isNumberKey(event)" readonly="true"/></td>';
		innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsTicketNo' + ltcJrnyTableIdlen + '" id="nonDTSPassDtlsTicketNo' + ltcJrnyTableIdlen + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="50" autocomplete="off"/></td>';
		innerHtmlValue = innerHtmlValue + '<td><select name="nonDTSPassDtlsJourneyPerformed' + ltcJrnyTableIdlen + '" id="nonDTSPassDtlsJourneyPerformed' + ltcJrnyTableIdlen + '_' + ltcJrnyPassTableIdlen + '" class="combo" style="width:80%;" onchange="takeLTCNonDTSCancellation(this.value,' + ltcJrnyTableIdlen + ',' + ltcJrnyPassTableIdlen + ');"><option value="">Select</option><option value="0">Yes</option><option value="1">No</option></select></td>';
		innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsBookingAmount' + ltcJrnyTableIdlen + '" id="nonDTSPassDtlsBookingAmount' + ltcJrnyTableIdlen + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="8" onblur="addNonDTSBookingAmount(' + ltcJrnyTableIdlen + ');" onkeypress="return isNumberKey(event)" autocomplete="off"/></td>';
		innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsRefundAmount' + ltcJrnyTableIdlen + '" id="nonDTSPassDtlsRefundAmount' + ltcJrnyTableIdlen + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="8" onblur="addNonDTSRefundAmount(' + ltcJrnyTableIdlen + ');" onkeypress="return isNumberKey(event)" autocomplete="off"/></td>';
		innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsClaimedAmount' + ltcJrnyTableIdlen + '" id="nonDTSPassDtlsClaimedAmount' + ltcJrnyTableIdlen + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="8" onblur="addNonDTSClaimedAmount(' + ltcJrnyTableIdlen + ');" onkeypress="return isNumberKey(event)" autocomplete="off"/></td>';
		...
		innerHtmlValue = innerHtmlValue + '</tr>';
		innerHtmlValue = innerHtmlValue + '</tbody>';
		innerHtmlValue = innerHtmlValue + '</table>';
		...
		$('#nonDTSJryStartDate' + ltcJrnyTableIdlen).datetimepicker({
			lang: 'en', scrollMonth: false, timepicker: true, format: 'd-m-Y H:i', formatDate: 'd-m-Y', maxDate: 0, step: 5, disabledDates: getLeaveDates(),
		...
		$('#nonDTSJryEndDate' + ltcJrnyTableIdlen).datetimepicker({
			lang: 'en', scrollMonth: false, timepicker: true, format: 'd-m-Y H:i', formatDate: 'd-m-Y', maxDate: 0, step: 5, disabledDates: getLeaveDates(),
...
function addLTCJrnyTraveller(index) {
	...
	if (valideteNonDtsLTCPassDetails(index)) {
		...
		innerHtmlValue = innerHtmlValue + '<td><select name="nonDTSPassDtlsTravellerName' + index + '" id="nonDTSPassDtlsTravellerName' + index + '_' + ltcJrnyPassTableIdlen + '" class="combo" style="width:90%;" onchange="setTravellerRelationAndAge(this.value,' + index + ',' + ltcJrnyPassTableIdlen + ');"><option value="">Select</option></td>';
		innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsRelation' + index + '" id="nonDTSPassDtlsRelation' + index + '_' + ltcJrnyPassTableIdlen + '" class="combo" style="width:80%;" onkeypress="return isNumberKey(event)" readonly="true"></td>';
		innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsAge' + index + '" id="nonDTSPassDtlsAge' + index + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="3" onkeypress="return isNumberKey(event)" readonly="true"/></td>';
		innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsTicketNo' + index + '" id="nonDTSPassDtlsTicketNo' + index + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="50" autocomplete="off"/></td>';
		innerHtmlValue = innerHtmlValue + '<td><select name="nonDTSPassDtlsJourneyPerformed' + index + '" id="nonDTSPassDtlsJourneyPerformed' + index + '_' + ltcJrnyPassTableIdlen + '" class="combo" style="width:80%;" onchange="takeLTCNonDTSCancellation(this.value,' + index + ',' + ltcJrnyPassTableIdlen + ');"><option value="">Select</option><option value="0">Yes</option><option value="1">No</option></select></td>';

		if ($("#nonDTSModeOfTravel" + index).val() == 'Train') {
			innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsBookingAmount' + index + '" id="nonDTSPassDtlsBookingAmount' + index + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="8" readonly="true" value="0" onkeypress="return isNumberKey(event)" autocomplete="off"/></td>';
			innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsRefundAmount' + index + '" id="nonDTSPassDtlsRefundAmount' + index + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="8" readonly="true" value="0" onkeypress="return isNumberKey(event)" autocomplete="off"/></td>';
			innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsClaimedAmount' + index + '" id="nonDTSPassDtlsClaimedAmount' + index + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="8" readonly="true" value="0" onkeypress="return isNumberKey(event)" autocomplete="off"/>&#160;<input type="button"  value="X" class="butn" onclick="deleteLTCJrnyTraveller(this,' + index + ')"></td>';
		} else {
			innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsBookingAmount' + index + '" id="nonDTSPassDtlsBookingAmount' + index + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="8" onblur="addNonDTSBookingAmount(' + index + ');" onkeypress="return isNumberKey(event)" autocomplete="off"/></td>';
			innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsRefundAmount' + index + '" id="nonDTSPassDtlsRefundAmount' + index + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="8" onblur="addNonDTSRefundAmount(' + index + ');" onkeypress="return isNumberKey(event)" autocomplete="off"/></td>';
			innerHtmlValue = innerHtmlValue + '<td><input type="text" name="nonDTSPassDtlsClaimedAmount' + index + '" id="nonDTSPassDtlsClaimedAmount' + index + '_' + ltcJrnyPassTableIdlen + '" class="txtfldM" style="width:80%;" maxlength="8" onblur="addNonDTSClaimedAmount(' + index + ');" onkeypress="return isNumberKey(event)" autocomplete="off"/>&#160;<input type="button"  value="X" class="butn" onclick="deleteLTCJrnyTraveller(this,' + index + ')"></td>';
...
function calculateLTCFinalAmount() {
	...
	var recoveryAmount =0;
	if ($("#irlaRecoveryAmt").val() != null && $("#irlaRecoveryAmt").val() != '') {
		recoveryAmount = Number($("#irlaRecoveryAmt").val());
	}
...
function createPTJrnyDetails() {
	...
	if (validetePTJrnyDetails()) {
		...
		var cell0 = row.insertCell(0);
		cell0.innerHTML = '<table width="100%" cellpadding="0" cellspacing="0" id="nonDTSJrnyDetls' + ptJrnyTableIdlen + '"></table>';
		...
		cell1.setAttribute("colspan", "3");
		cell1.className = "shift";
		cell1.innerHTML = 'Journey Type:<select name="nonDTSJourneyType" id="nonDTSJourneyType' + ptJrnyTableIdlen + '" class="combo"  style="width:100px;"><option value="">Select</option><option value="0">Onward</option><option value="1">Return</option></select>' +
		...
		var innerHtmlValue = '<table class="filtersearch" cellspacing="1" cellpadding="4" width="100%" border="0" id="nonDTSJrnyPassDetls' + ptJrnyTableIdlen + '">';
		innerHtmlValue = innerHtmlValue + '<tbody class="all3">';
		innerHtmlValue = innerHtmlValue + '<tr class="lablevalue"><td style="width:10%;">Traveler Name</td><td style="width:10%;">Relation</td><td style="width:5%;">Age</td><td style="width:10%;">Ticket No</td><td style="width:10%;">Journey Performed?</td><td style="width:10%;">Booking Amount</td><td style="width:10%;">Refund Amount</td><td style="width:10%;">Claimed Amount</td></tr>';

		innerHtmlValue = innerHtmlValue + '<tr class="lablevalue">';
		innerHtmlValue = innerHtmlValue + '<td><select name="nonDTSPassDtlsTravellerName' + ptJrnyTableIdlen + '" id="nonDTSPassDtlsTravellerName' + ptJrnyTableIdlen + '_' + ptJrnyPassTableIdlen + '" class="combo" style="width:90%;" onchange="setTravellerRelationAndAge(this.value,' + ptJrnyTableIdlen + ',' + ptJrnyPassTableIdlen + ');"><option value="">Select</option></td>';
		...
		$('#nonDTSJryStartDate' + ptJrnyTableIdlen).datetimepicker({
			lang: 'en', scrollMonth: false, timepicker: true, format: 'd-m-Y H:i', formatDate: 'd-m-Y', maxDate: 0, step: 5, disabledDates: getLeaveDates(),
			scrollInput:false,defaultDate: $("#start_date_time").val(), onSelectDate: function(current_time, $input) { validateLTCFromDate(3, ptJrnyTableIdlen); },
		onShow: function () {
			  $('#nonDTSJryStartDate' + ptJrnyTableIdlen).val("");
		}
		});
		$('#nonDTSJryEndDate' + ptJrnyTableIdlen).datetimepicker({
			lang: 'en', scrollMonth: false, timepicker: true, format: 'd-m-Y H:i', formatDate: 'd-m-Y', maxDate: 0, step: 5, disabledDates: getLeaveDates(),
			scrollInput:false,defaultDate: $("#start_date_time").val(), onSelectDate: function(current_time, $input) { validateLTCToDate(3, ptJrnyTableIdlen); },
		onShow: function () {
...
function addPTJrnyTraveller(index) {
	...
	if (valideteNonDtsPTPassDetails(index)) {
		...
		var innerHtmlValue = innerHtmlValue + '<tr class="lablevalue">';
		innerHtmlValue = innerHtmlValue + '<td><select name="nonDTSPassDtlsTravellerName' + index + '" id="nonDTSPassDtlsTravellerName' + index + '_' + ptJrnyPassTableIdlen + '" class="combo" style="width:90%;" onchange="setTravellerRelationAndAge(this.value,' + index + ',' + ptJrnyPassTableIdlen + ');"><option value="">Select</option></td>';
...
function validetePTJrnyDetails() {
	...
	if (nonDTSJourneyType.length == 0) {
		...
		if (nonDTSClassOfTravel.length > 0) {
			for (var i = 0; i < nonDTSClassOfTravel.length; i++) {
				if (nonDTSClassOfTravel[i].value == "") {
					alert("Please select Class of Accommodation");
					nonDTSClassOfTravel[i].focus();
					return false;
				}
			}
...
//			console.log(Number($("#jrnyClaimedAmount" + dtsPTJrnyTableIdlen[index].value).val()));
...
function setCartageDetails(val) {
	...
	if (val == "Train" || val == "Steamer") {
		...
		innerHTML = innerHTML + '<select name="particularConveyance_0" class="combo" style="width:50%">';
		...
		innerHTMLTwo = innerHTMLTwo + '<select name="particularConveyance_0" class="combo" style="width:50%">';
...
function setConveyanceLuggage(val) {
	...
	if (val == 1) {
		...
		var innerHTML = "";
		innerHTML = innerHTML + '<tbody class="all1">';
		innerHTML = innerHTML + '<tr class="lablevalue">';
		innerHTML = innerHTML + '<td style="width:20%;background-color:#EBF4FA;border-right:2px solid white">Mode of Conveyance</td>';
		innerHTML = innerHTML + '<td style="width:20%;background-color:#EBF4FA;border-right:2px solid white">Distance (in Kms)</td>';
		innerHTML = innerHTML + '<td style="width:20%;background-color:#EBF4FA;">Claimed Amount</td>';
		innerHTML = innerHTML + '</tr>';
		innerHTML = innerHTML + '<tr class="lablevalue"><input type="hidden" name="particularName_1" value="Transportation of Conveyance"/>';
		innerHTML = innerHTML + '<td style="width:25%;">';
		innerHTML = innerHTML + '<select name="particularConveyance_1" class="combo" style="width:50%">';
		...
		innerHTML = innerHTML + '</select>';
		innerHTML = innerHTML + '</td>';
		innerHTML = innerHTML + '<td style="width:25%;"><input type="text" name="particularDistance_1" id="particularDistance_1_1" onkeypress="return isNumberKey(event)" maxlength="10" autocomplete="off" style="width:50%"></td>';
		innerHTML = innerHTML + '<td style="width:25%;"><input type="text" name="particularClaimAmt_1" id="particularClaimAmt_1_1" onblur="validateConveyanceAmount();calculatePTFinalAmount();" style="width:50%" onkeypress="return isNumberKey(event)" maxlength="10" autocomplete="off"/></td>';
		innerHTML = innerHTML + '</tr>';
...
if($("#personalPayAccNo").val().trim() == ''){
	alert("Pay Account No should not be blank.");
	$("#personalPayAccNo").focus();
	return false;
}
	...
	var dtsLtcJrnyTableIdlen = $("#voucherSettlementConfirmationForm input[name=dtsPTJrnyTableIdlen]");
	var jrnyFlag = true;
	for (var index = 0; index < dtsLtcJrnyTableIdlen.length; index++) {
		var val = dtsLtcJrnyTableIdlen[index].value;
		var dtsJourneyPerformed = $("#voucherSettlementConfirmationForm select[name=dtsJourneyPerformed" + val + "]");
...
function validateCTGAmount() {
	...
	if (parseInt(totalCtg) > maxctg) {
		alert("CTG Claimed Amount should not be more than " + maxctg);
		$("#Claim_GTC_Amt").val(0);
		$("#Claim_GTC_Amt").focus();
		return false
	}
