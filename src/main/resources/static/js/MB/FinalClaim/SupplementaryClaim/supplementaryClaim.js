...
function myCreateFunction(detail){
	...
	if(detail=='hotelAddmore')
	{
		if(validateLeaveDetails() && valideteHotelDetails())
		{
			...
			var innerHtmlValue = '' ;
			    innerHtmlValue='<td><select name="hotelOrMess" id="hotelOrMess'+hotelTableIdlen+'" class="combo" style="width:70px;" onchange="takeMessOrNACInfo(this.value,'+hotelTableIdlen+');"><option value="">Select</option><option value="Hotel">Hotel</option><option value="Mess">Mess</option></select></td>' ;
			    ...
			    innerHtmlValue=innerHtmlValue+'<input type="text" name="hotelAmount" id="hotelAmount'+hotelTableIdlen+'" onkeypress="return isNumberKey(event)"  onblur="getAmount(1,'+hotelTableIdlen+');" size="7" class="txtfldM" maxlength="7" autocomplete="off"/><input type="hidden" name="actualHotelAmount" id="actualHotelAmount'+hotelTableIdlen+'"/></td>';
		     ...
		     if(0==foodTableIdlen || !validFoodHeaderFlag)
			 {
			    ...
			    var cell4 = row.insertCell(2);
			   	...
			   	var innerHtmlValue='';
				    ...
				    var cell30 =  row0.insertCell(2);
				        ...
				        cell10.innerHTML = "<b>Is the Non-drawl for Ration Certificate issued by the Quarter Master of the Parent Unit ?</b>";
					    cell20.innerHTML = "<b>Number of Days</b>";
					    cell30.innerHTML = "<b>Amount</b>";
			    ...
			    var cell4 = row.insertCell(3);
			   	...
			   	var innerHtmlValue='';
			        ...
			        innerHtmlValue='';
				    innerHtmlValue='<td ><input type="text" name="foodNoDay" id="foodNoDay'+foodTableIdlen+'"  class="txtfldM" size="10" maxlength="5" onkeypress="return isNumericOnlyKey(event)"  onblur="calculateFoodAmount('+foodTableIdlen+');" autocomplete="off"/></td>';
				    cell2.innerHTML = innerHtmlValue;
				    
				    innerHtmlValue = '' ;
				    innerHtmlValue=innerHtmlValue+ '<td ><input type="text" name="foodAmount" id="foodAmount'+foodTableIdlen+'" onkeypress="return isNumberKey(event)" class="txtfldM" size="10" maxlength="10" onblur="validateFoodAmount('+foodTableIdlen+');" autocomplete="off"/><input type="hidden" name="actualFoodAmount" id="actualFoodAmount'+foodTableIdlen+'"/></td>';
				    cell3.innerHTML = innerHtmlValue;
   ...
   if(detail=='tourAddmore')
   {
   		if(validateLeaveDetails() && valideteTourDetails())
		{
		   ...
		   if($("#is_conveyanceDtls").val()==0){ 
		    ...
		    var innerHtmlValue='';
			    innerHtmlValue='<td ><input type="text" name="tourVehicleNo" id="tourVehicleNo'+tourTableIdlen+'"  class="txtfldM" size="20" style="width:80%" maxlength="20" autocomplete="off"/></td>';
			    cell1.innerHTML = innerHtmlValue;
			    
			    innerHtmlValue = '' ;
			    innerHtmlValue='<td ><input type="text" readonly="true" name="tourDate" id="tourDate'+tourTableIdlen+'" class="txtfldM" size="12" style="width:80%" maxlength="20" autocomplete="off"/></td>';
			    cell2.innerHTML = innerHtmlValue;
			    
			    innerHtmlValue = '' ;
			    innerHtmlValue='<td ><input type="text" name="tourDistance" id="tourDistance'+tourTableIdlen+'" class="txtfldM" size="8" maxlength="10" style="width:80%" onkeypress="return isNumericOnlyKey(event)" autocomplete="off"/></td>';
			    cell3.innerHTML = innerHtmlValue;
			    
			    innerHtmlValue = '' ;
			    innerHtmlValue='<td ><input type="text" name="tourBillNo" id="tourBillNo'+tourTableIdlen+'" class="txtfldM" size="10" maxlength="30" style="width:80%" autocomplete="off"/></td>';
			    cell4.innerHTML = innerHtmlValue;
			    
			 
			    innerHtmlValue = '' ;
			    innerHtmlValue=innerHtmlValue+'<td ><input type="text" name="tourAmount" id="tourAmount'+tourTableIdlen+'" onkeypress="return isNumberKey(event)" onblur="getAmount(3,'+tourTableIdlen+');" class="txtfldM" size="10" maxlength="10" style="width:80%" autocomplete="off"/><input type="hidden" name="actualTourAmount" id="actualTourAmount'+tourTableIdlen+'"/></td>';
			    cell5.innerHTML = innerHtmlValue;
   ...
   if(detail=='taAddmore')
   {
		...
		if(validateLeaveDetails() && valideteTADetails())
		{
		    ...
		    var innerHtmlValue='';
			    ...
			    innerHtmlValue = '' ;
			    innerHtmlValue='<td><input type="text"   name="nonDTSJryStartDate" id="nonDTSJryStartDate'+taTableIdlen+'" size="12" class="txtfldM" style="width:85%" readonly="true" autocomplete="off"/></td>';
			    cell5.innerHTML = innerHtmlValue;
			    
			    innerHtmlValue = '' ;
			    innerHtmlValue='<td><input type="text" name="nonDTSJryEndDate" id="nonDTSJryEndDate'+taTableIdlen+'" class="txtfldM" size="13" style="width:100%" maxlength="20" readonly="true" autocomplete="off"/></td>';
			    cell6.innerHTML = innerHtmlValue;
   	 ...
   	 if(detail=='leavePeriodAddmore')
   {
		if(valideteLeavePeriodDetails())
		{
		    ...
		    var innerHtmlValue='';
			   ...
			   $('#leavePeriodDate'+leaveTableIdlen).datetimepicker({lang:'en',scrollMonth:false,timepicker:false,format:'d-m-Y',formatDate:'d-m-Y',maxDate:0,disabledDates:getSelfLeave(),
...
function calculateFoodAmount(index){
	...
	daysFoodAmount=Number(maxFoodAmt)*Number(foodNoDay);
	
	
	if($("#nonDrawlCertificate"+index).val()==1){
		rationMoney=Number(maxRationAmt)*Number(foodNoDay);
	}
	
	$("#actualFoodAmount"+index).val(parseInt(daysFoodAmount-rationMoney));
...
function calculateFinalAmount(){
	...
	var totalClaimedAmount=Number(totalSpentAmount)-Number(totalAdvanceTaken)+Number(totalRefundAmount);
	
	$("#total_spent_amount").html(parseInt(totalSpentAmount));
	$("#total_advance_amount").html(parseInt(totalAdvanceTaken));
	$("#total_refund_amount").html(parseInt(totalRefundAmount));
	...
	$("#totalRefundAmount").val(parseInt(totalRefundAmount));
		  ...
		  if(city.length>2)
		   {
			...
			var cityList="";
		    $.ajax({
			url: $("#context_path").val() + "mb/getCityListSup",
			type: "post",
			data: "city=" + city,
...
function getCounterPersonalInfo(){
	 ...
	 $.ajax({
		      url: $("#context_path").val() + "mb/supCounterPersonalInfo",
		      type: "post",
	   ...
	   if(hotelName.length > 0){
	   	 var flag=true;
				...
				if($("#dy_Certify_Ques").length==0){
					$('#certify_that_tb tbody').append('<tr id="dy_Certify_Ques"><td style="width:5%"><input type="checkbox" name="claimCertify" value="'+hotelCertifyQues+'" /></td>' +
				    '<td style="width:95%">'+hotelCertifyQues+'</td></tr>');
				}else{
					$('#dy_Certify_Ques').html('<td style="width:5%"><input type="checkbox" name="claimCertify" value="'+hotelCertifyQues+'" /></td>' +
				    '<td style="width:95%">'+hotelCertifyQues+'</td>');
				}
			}else{
...
if(flag){
  ...
  if(travelType=='100002'){
	 ...
	 innerHTML=innerHTML+'<tr class="tadaHeading"><td>B. Leave during TD Period</td></tr></tbody></table>';
	...
	if(hotelTableIdlen.length>0){
	    ...
	    innerHTML=innerHTML+'<table  class="filtersearch"><tbody class="all1">';
		innerHTML=innerHTML+'<tr class="lablevaluebg"><td class="lablevalue" style="width:100px;">Hotel/Mess</td><td class="lablevalue" style="width:70px;">Hotel/MESS Name</td>';
		innerHTML=innerHTML+'<td class="lablevalue" style="width:120px;">Hotel/MESS location</td><td class="lablevalue" style="width:110px;">Hotel GST No</td><td class="lablevalue" style="width:110px;">';
		innerHTML=innerHTML+'Check In Date</td><td class="lablevalue" style="width:110px;">Check Out Date</td><td class="lablevalue" style="width:110px;">Number of Days</td>';
		innerHTML=innerHTML+'<td class="lablevalue" style="width:140px;">Hotel Bill (Excluding GST)</td><td class="lablevalue" style="width:60px;">GST Amt</td></tr>';
	...
	if(foodTableIdlen.length>0){
	    ...
	    innerHTML=innerHTML+'<table class="filtersearch"><tbody class="all1">';
		innerHTML=innerHTML+'<tr class="lablevaluebg"><td class="lablevalue" style="width:40%;">';
		if($("#userServiceType").val()!='1'){
		...
		for(var i=0;i<foodTableIdlen.length;i++){
		  ...
		  innerHTML=innerHTML+'<tr class="lablevaluebg"><td style="width:40%;">'+$("#nonDrawlCertificate"+val+" option:selected").text()+'</td>';
		  innerHTML=innerHTML+'<td style="width:20%;">'+$("#foodNoDay"+val).val()+'</td>';
		  innerHTML=innerHTML+'<td style="width:20%;">'+$("#foodAmount"+val).val()+'</td></tr>';
		...
		innerHTML=innerHTML+'<tr class="tadaHeading"><td>G. Taxi Charges within TD City </td></tr></tbody></table>';
		 ...
		 if($("#is_conveyanceDtls").val()==0){ 
			...
			for(var i=0;i<tourTableIdlen.length;i++){
			  ...
			  innerHTML=innerHTML+'<tr class="lablevaluebg"><td width="25%;">'+$("#tourVehicleNo"+val).val()+'</td>';
			  innerHTML=innerHTML+'<td width="15%;">'+$("#tourDate"+val).val()+'</td>';
			  innerHTML=innerHTML+'<td width="15%;">'+$("#tourDistance"+val).val()+'</td>';
			  innerHTML=innerHTML+'<td width="15%;">'+$("#tourBillNo"+val).val()+'</td>';
			  innerHTML=innerHTML+'<td width="20%;">'+$("#tourAmount"+val).val()+'</td></tr>';
	...
	innerHTML=innerHTML+'<td>'+'0.0'+'</td></tr></tr></tbody></table></div>';
	...
	innerHTML=innerHTML+'<table class="filtersearch" width="100%" cellspacing="0"  cellpadding="4" border="0"><tbody class="all1">';
	...
	var ltcJrnyTableIdlen = $("#voucherSettlementConfirmationForm input[name=ltcJrnyTableIdlen]");
	 if(ltcJrnyTableIdlen.length>0){
	   for(var i=0;i<ltcJrnyTableIdlen.length;i++){
		  ...
		  innerHTML=innerHTML+'<div class="welcomebox" style="margin-bottom:2px"><table id="ltcNonDtsJrnyTableGrid" class="filtersearch">';
          innerHTML=innerHTML+'<tr><td><table class="filtersearch"><tbody class="all1"><tr>';
          innerHTML=innerHTML+'<td colspan="5" bgcolor="#AAAAAA" align="left"></td><td class="lablevalue" colspan="3" bgcolor="#AAAAAA" align="right">';
          ...
          innerHTML=innerHTML+'</td></tr><tr><td colspan="10" align="right"></td></tr><tr><td style="padding:5px;" colspan="11" bgcolor="#003A70" align="left">';
	...
	innerHTML=innerHTML+'<div class="welcomebox" style="margin-bottom:2px"><table class="filtersearch"><tbody class="all1">';
    innerHTML=innerHTML+'<tr class="tadaHeading"><td colspan="4">Details of Recovery against this Travel (if any)</td></tr>';
 	innerHTML=innerHTML+'<tr class="lablevalue"><td>IRLA Recovery Amount</td>';
	innerHTML=innerHTML+'<td>'+'0.0'+'</td></tr></tr></tbody></table></div>';
//	innerHTML=innerHTML+'<td>'+$("#irlaRecoveryAmt").val()+'</td></tr></tr></tbody></table></div>';
	...
	var ptJrnyTableIdlen = $("#voucherSettlementConfirmationForm input[name=ptJrnyTableIdlen]");
	 if(ptJrnyTableIdlen.length>0){
	   for(var i=0;i<ptJrnyTableIdlen.length;i++){
          ...
          innerHTML=innerHTML+'<tr><td><table class="filtersearch" width="100%" cellspacing="0" cellpadding="0"><tbody class="all1"><tr>';
          innerHTML=innerHTML+'<td colspan="5" bgcolor="#AAAAAA" style="text-align:left"></td><td colspan="3" bgcolor="#AAAAAA" style="text-align:right">';
          innerHTML=innerHTML+'Journey Type:'+$("#nonDTSJourneyType"+val+" option:selected").text()+'</td></tr>';
          innerHTML=innerHTML+'<tr><td class="lablevalue">Mode of Travel</td><td>'+$("#nonDTSModeOfTravel"+val+" option:selected").text();
          innerHTML=innerHTML+'</td><td class="lablevalue">Departure Place</td><td>'+$("#nonDTSFromPlace"+val).val()+'</td><td><b>Arrival Place</b></td><td>';
          innerHTML=innerHTML+$("#nonDTSToPlace"+val).val()+'</td><td class="lablevalue">Class of Accommodation</td><td>'+$("#nonDTSClassOfTravel"+val+" option:selected").text();
          innerHTML=innerHTML+'</td></tr><tr><td class="lablevalue">Departure Time</td><td>'+$("#nonDTSJryStartDate"+val).val();
          innerHTML=innerHTML+'</td><td class="lablevalue">Arrival Time</td><td>'+$("#nonDTSJryEndDate"+val).val()+'</td><td>Sector</td><td>';
          innerHTML=innerHTML+$("#nonDTSSector"+val).val()+'</td><td class="lablevalue">Bill/PNR/ Ticket No.</td><td>'+$("#nonDTSTicketNo"+val).val();
          innerHTML=innerHTML+'</td></tr><tr><td class="lablevalue">Distance (KM)</td><td>'+$("#nonDTSDistanceKM"+val).val()+'</td><td class="lablevalue">Total Fare';
          innerHTML=innerHTML+'</td><td>'+$("#nonDTSJryAmount"+val).val()+'</td><td class="lablevalue">Total Refund</td><td>'+$("#nonDTSJryRefundAmount"+val).val();
          innerHTML=innerHTML+'</td><td class="lablevalue">Total Claimed Amount</td><td>'+$("#nonDTSJryClaimAmount"+val).val();
          innerHTML=innerHTML+'</td></tr><tr><td colspan="10" align="right"></td></tr><tr><td style="padding:5px;" colspan="11" bgcolor="#003A70" align="left">';
          innerHTML=innerHTML+'<table class="filtersearch" width="100%" cellspacing="1" cellpadding="4" border="0"><tbody class="all1"><tr class="lablevalue">';
          innerHTML=innerHTML+'<td style="width:10%;">Traveller Name</td><td style="width:10%;">Relation</td><td style="width:5%;">';
          innerHTML=innerHTML+'Age</td><td style="width:10%;">Ticket No</td><td style="width:10%;">Journey Performed?</td>';
          innerHTML=innerHTML+'<td style="width:10%;">Booking Amount</td><td style="width:10%;">Refund Amount</td><td style="width:10%;">';
          innerHTML=innerHTML+'Claimed Amount</td></tr>';
	 ...
	 innerHTML=innerHTML+'<table class="filtersearch"><tbody class="all1">';
	 innerHTML=innerHTML+'<tr class="lablevalue"><td style="width:20%;background-color:#EBF4FA;border-right:1px solid white">Particulars</td>'; 
	...
	innerHTML=innerHTML+'<td style="width:20%;">Luggage including Cartage if any</td><td style="width:15%;">Coveyance</td>'; 
...
//	innerHTML=innerHTML+'<td>'+$("#irlaRecoveryAmt").val()+'</td></tr></tr></tbody></table></div>';
	...
	innerHTML=innerHTML+'<p>Certify that</p></div><div class="welcomecont"><table class="filtersearch"><tbody class="all1">';
...
//		var path = encodeURIComponent(fileTypePath[i].value);
	...
	innerHTML=innerHTML+'<tr><td class="lablevalue" colspan="4">';
	...
	innerHTML=innerHTML+'<td colspan="3"><span class="lablevalue">Sanction Date:</span>'+$("#claimPreferredSanctionDate").val()+'</td></tr></tbody></table></div>';
	
	innerHTML=innerHTML+'<table class="filtersearch" width="100%" border="0" align="center">';
...
function saveClaimAsDraft(travelType){
	...
	if(confirm("Are you sure that you want to save claim as draft?")){
    	...
    	document.voucherSettlementConfirmationForm.method="post";
	  	document.getElementById("event").value='draft';
	  	var actionOriginal=document.voucherSettlementConfirmationForm.action;
	    document.voucherSettlementConfirmationForm.action=actionOriginal.replace('/page', "");
	    document.voucherSettlementConfirmationForm.submit();	
	}else{
		return false;
	}
...
function createLTCJrnyDetails(){
	...
	if(valideteLTCJrnyDetails()){
		 ...
		 cell0.innerHTML ='<table width="100%" cellpadding="0" cellspacing="0" id="nonDTSJrnyDetls'+ltcJrnyTableIdlen+'" class="filtersearch"><tbody class="all1"></table>';
		 ...
		 cell1.className = "shift lablevalue";
		 ...
		 cell6.innerHTML ='Class of Accommodation';
...
function getClaimAirportList(id,index) {
	...
	var AirportList="";
	$.ajax({
			url: $("#context_path").val() + "mb/getNAPForSupClaim",
			type: "post",
...
function getClaimRailStationList(id,index) {
	...
	var StationList="";
	$.ajax({
			url: $("#context_path").val() + "mb/getStationListForSupClaim",
			type: "post",
	...
	if(passTravellerName.length > 0){
		for(var i=0;i<passTravellerName.length-1;i++){
			if(passTravellerName[i].value==val){
				alert("Traveller already selected");
...
function createPTJrnyDetails(){
	...
	if(validetePTJrnyDetails()){
		...
		// row2.className = "lablevalue";
		 ...
		 var innerHtmlValue= '<table class="filtersearch" cellspacing="1" cellpadding="4" width="100%" border="0" id="nonDTSJrnyPassDetls'+ptJrnyTableIdlen+'"><tbody class="all3">';
		 innerHtmlValue=innerHtmlValue+'<tr class="lablevalue"><td style="width:10%">Traveler Name</td><td style="width:10%">Relation</td><td style="width:5%">Age</td><td style="width:10%">Ticket No</td><td style="width:10%">Journey Performed?</td><td style="width:10%">Booking Amount</td><td style="width:10%">Refund Amount</td><td style="width:10%">Claimed Amount</td></tr>';
...
function setConveyanceLuggage(val){
	...
	if(val==1){
		...
		innerHTML=innerHTML+'</select>';
		innerHTML=innerHTML+'</td>'; 
		innerHTML=innerHTML+'<td style="width:25%;"><input type="text" name="particularDistance_1" id="particularDistance_1_1" onkeypress="return isNumberKey(event)" style="width:50%" maxlength="10" autocomplete="off"/></td>'; 
		innerHTML=innerHTML+'<td style="width:25%;"><input type="text" name="particularClaimAmt_1" id="particularClaimAmt_1_1" style="width:50%" onblur="validateConveyanceAmount();calculatePTFinalAmount();" onkeypress="return isNumberKey(event)" maxlength="10" autocomplete="off"/></td>'; 
