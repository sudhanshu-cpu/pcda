...
function myCreateFunction(detail){
	...
	if(detail=='hotelAddmore')
	{
	   ...
	   $('#checkInDate'+hotelTableIdlen).datetimepicker({lang:'en',scrollMonth:false,timepicker:true,format:'d-m-Y H:i',formatDate:'d-m-Y H:i',maxDate:0,step:5,disabledDates:getLeaveDates(),
			                                   defaultDate:$("#travel_Start_Date").val(),scrollInput:false,yearEnd : 2100,
		onShow: function () {
			  $('#checkInDate'+hotelTableIdlen).val("");
		},onSelectDate: function(current_time,$input){validateFromDate(1,hotelTableIdlen);}});

	   $('#checkOutDate'+hotelTableIdlen).datetimepicker({lang:'en',scrollMonth:false,timepicker:true,format:'d-m-Y H:i',formatDate:'d-m-Y H:i',maxDate:0,step:5,disabledDates:getLeaveDates(),
			                                   defaultDate:$("#travel_Start_Date").val(),scrollInput:false,yearEnd : 2100,
		onShow: function () {
			  $('#checkOutDate'+hotelTableIdlen).val("");
		},onSelectDate: function(current_time,$input){validateDate(1,hotelTableIdlen);}});
		     ...
		     if(0==foodTableIdlen || !validFoodHeaderFlag)
			 {
			    ...
			    var cell4 = row.insertCell(3);
			   	...
			   	var innerHtmlValue='';
			        ...
			        innerHtmlValue='';
				    innerHtmlValue='<td ><input type="text" name="foodNoDay" id="foodNoDay'+foodTableIdlen+'"  class="txtfldM" style="width:50%;" size="10" maxlength="5" onkeypress="return isNumericOnlyKey(event)"  onblur="calculateFoodAmount('+foodTableIdlen+');" autocomplete="off"/></td>';
				    cell2.innerHTML = innerHtmlValue;
   ...
   if(detail=='tourAddmore')
   {
		...
		onShow: function () {
		...
		},onSelectDate: function(current_time,$input){validateFromDate(3,tourTableIdlen);}});
		 }else{
		    ...
		    var innerHtmlValue='';
			    innerHtmlValue='<td ><input type="text" name="tourNoOfDays" id="tourNoOfDays'+tourTableIdlen+'"  class="txtfldM" style="width:80%" size="10" maxlength="5" onkeypress="return isNumericOnlyKey(event)" autocomplete="off"/></td>';
			    cell1.innerHTML = innerHtmlValue;
   ...
   if(detail=='taAddmore')
   {
		...
		if(validateLeaveDetails() && valideteTADetails())
		{
		    ...
		    var innerHtmlValue='';
			    ...
			    innerHtmlValue = '' ;
			    innerHtmlValue='<td><input type="text"   name="nonDTSJryStartDate" id="nonDTSJryStartDate'+taTableIdlen+'" size="11" class="txtfldM" style="width:85%" readonly="true" autocomplete="off"/></td>';
			    cell5.innerHTML = innerHtmlValue;
			    
			    innerHtmlValue = '' ;
			    innerHtmlValue='<td><input type="text" name="nonDTSJryEndDate" id="nonDTSJryEndDate'+taTableIdlen+'" class="txtfldM" size="13" style="width:95%" maxlength="20" readonly="true" autocomplete="off"/></td>';
			    cell6.innerHTML = innerHtmlValue;
   ...
   $('#nonDTSJryStartDate'+taTableIdlen).datetimepicker({lang:'en',scrollMonth:false,timepicker:true,format:'d-m-Y H:i',formatDate:'d-m-Y H:i',maxDate:0,step:5,disabledDates:getLeaveDates(),
			                                                defaultDate:$("#travel_Start_Date").val(),scrollInput:false,yearEnd : 2100,
		onShow: function () {
			  $('#nonDTSJryStartDate'+taTableIdlen).val("");
		},onSelectDate: function(current_time,$input){validateFromDate(6,taTableIdlen);} });

   $('#nonDTSJryEndDate'+taTableIdlen).datetimepicker({lang:'en',scrollMonth:false,timepicker:true,format:'d-m-Y H:i',formatDate:'d-m-Y H:i',maxDate:0,step:5,disabledDates:getLeaveDates(),
			                                                defaultDate:$("#travel_Start_Date").val(),scrollInput:false,yearEnd : 2100,
		onShow: function () {
			  $('#nonDTSJryEndDate'+taTableIdlen).val("");
		},onSelectDate: function(current_time,$input){validateDate(6,taTableIdlen);} });
		 }
   	}
...
function getLeaveDates(){
	...
	var leavePeriodDate = $("input[name='leavePeriodDate']");
	var leaveFullHalf = $("input[name='leaveFullHalf']");		
...
if(flag){
  ...
  if(travelType=='100002'){
	...
	innerHTML=innerHTML+'<tr class="tadaHeading"><td align="left"><b>Non DTS Journey Details</b></td><td colspan="11" align="right"></td></tr></tbody></table></div></div></div>';
	...
	innerHTML=innerHTML+'<td>Date of Advance Drawn from PAO</td><td>Advance Drawn from Other Sources</td>';
	innerHTML=innerHTML+'<td>Voucher No for Advance Drawn from Other Sources</td><td><b>Date of Advance Drawn from Other Sources</td></tr>';
	...
	innerHTML=innerHTML+'<div class="welcomebox" style="margin-bottom:2px"><table class="filtersearch"><tbody class="all1">';
	innerHTML=innerHTML+'<tr class="tadaHeading"><td align="left"><b>Non DTS Journey Details</b></td><td colspan="11" align="right"></td></tr></tbody></table></div>';
	...
	var ptJrnyTableIdlen = $("#voucherSettlementConfirmationForm input[name=ptJrnyTableIdlen]");
	 if(ptJrnyTableIdlen.length>0){
	   for(var i=0;i<ptJrnyTableIdlen.length;i++){
		  ...
		  innerHTML=innerHTML+'<div class="welcomebox" style="margin-bottom:2px"><table id="ptNonDtsJrnyTableGrid" class="filtersearch">';
          innerHTML=innerHTML+'<tr><td><table class="filtersearch"><tbody class="all1"><tr class="lablevalue">';
	...
	innerHTML=innerHTML+'<table class="filtersearch"> <tbody class="all1">';
	innerHTML=innerHTML+'<tr><td>Document Name</td><td>File</td></tr>';
...
//		 var path = encodeURIComponent(fileTypePath[i].value);
	...
	innerHTML=innerHTML+'<div class="welcomebox" style="margin-bottom:2rem"><table class="filtersearch"><tbody class="all1">';
	if($("#userServiceType").val()== '1'){
...
function saveClaimAsDraft(travelType){
	...
	if(confirm("Are you sure that you want to save claim as draft?")){
		...
		$('#voucherSettlementConfirmationForm').attr('action', $("#context_path").val() + 'mb/updateClaimAsDraft');
		$('#voucherSettlementConfirmationForm').submit();
...
function createLTCJrnyDetails(){
	...
	if(valideteLTCJrnyDetails()){
		 ...
		 cell0.innerHTML ='<table width="100%" cellpadding="0" cellspacing="0" id="nonDTSJrnyDetls'+ltcJrnyTableIdlen+'"><tbody class="all1"></tbody></table>';
		...
		innerHtmlValue = innerHtmlValue + '</table>';
		 ...
		 $('#nonDTSJryStartDate'+ltcJrnyTableIdlen).datetimepicker({lang:'en',scrollMonth:false,timepicker:true,format:'d-m-Y H:i',formatDate:'d-m-Y H:i',maxDate:0,step:5,disabledDates:getLeaveDates(),
			                                                defaultDate:$("#travel_Start_Date").val(),scrollInput:false,yearEnd : 2100,
		onShow: function () {
			  $('#nonDTSJryStartDate'+ltcJrnyTableIdlen).val("");
		},onSelectDate: function(current_time,$input){validateLTCFromDate(3,ltcJrnyTableIdlen);} });
		 $('#nonDTSJryEndDate'+ltcJrnyTableIdlen).datetimepicker({lang:'en',scrollMonth:false,timepicker:true,format:'d-m-Y H:i',formatDate:'d-m-Y H:i',maxDate:0,step:5,disabledDates:getLeaveDates(),
			                                                defaultDate:$("#travel_Start_Date").val(),scrollInput:false,yearEnd : 2100,
		onShow: function () {
			  $('#nonDTSJryEndDate'+ltcJrnyTableIdlen).val("");
		},onSelectDate: function(current_time,$input){validateLTCToDate(3,ltcJrnyTableIdlen);} });
	}
...
function addLTCJrnyTraveller(index){
	...
	if(valideteNonDtsLTCPassDetails(index)){
		ltcJrnyPassTableIdlen++;
		 ...
		 innerHtmlValue=innerHtmlValue+'<td><input type="text" name="nonDTSPassDtlsRefundAmount'+index+'" id="nonDTSPassDtlsRefundAmount'+index+'_'+ltcJrnyPassTableIdlen+'" class="txtfldM" style="width:70%;" maxlength="8" readonly="true" value="0" onkeypress="return isNumberKey(event)" autocomplete="off"/></td>';
		 innerHtmlValue=innerHtmlValue+'<td><input type="text" name="nonDTSPassDtlsClaimedAmount'+index+'" id="nonDTSPassDtlsClaimedAmount'+index+'_'+ltcJrnyPassTableIdlen+'" class="txtfldM" style="width:70%;" maxlength="8" readonly="true" value="0" onkeypress="return isNumberKey(event)" autocomplete="off"/>&#160;<input type="button"  value="X" class="butn" onclick="deleteLTCJrnyTraveller(this,'+index+')"></td>';
		 }else{
		 innerHtmlValue=innerHtmlValue+'<td><input type="text" name="nonDTSPassDtlsBookingAmount'+index+'" id="nonDTSPassDtlsBookingAmount'+index+'_'+ltcJrnyPassTableIdlen+'" class="txtfldM" style="width:32%;" maxlength="8" onblur="addNonDTSBookingAmount('+index+');" onkeypress="return isNumberKey(event)" autocomplete="off"/></td>' ;
		 innerHtmlValue=innerHtmlValue+'<td><input type="text" name="nonDTSPassDtlsRefundAmount'+index+'" id="nonDTSPassDtlsRefundAmount'+index+'_'+ltcJrnyPassTableIdlen+'" class="txtfldM" style="width:32%;" maxlength="8" onblur="addNonDTSRefundAmount('+index+');" onkeypress="return isNumberKey(event)" autocomplete="off"/></td>';
		 innerHtmlValue=innerHtmlValue+'<td><input type="text" name="nonDTSPassDtlsClaimedAmount'+index+'" id="nonDTSPassDtlsClaimedAmount'+index+'_'+ltcJrnyPassTableIdlen+'" class="txtfldM" style="width:32%;" maxlength="8" onblur="addNonDTSClaimedAmount('+index+');" onkeypress="return isNumberKey(event)" autocomplete="off"/>&#160;<input type="button"  value="X" class="butn" onclick="deleteLTCJrnyTraveller(this,'+index+')"></td>';
	...
	if(passTravellerName.length > 0){
		for(var i=0;i<passTravellerName.length;i++){
			if(passTravellerName[i].value==""){
				alert("Please select Traveller Name");
				return false;
			}
		}
	}
...
function createPTJrnyDetails(){
	...
	if(validetePTJrnyDetails()){
		 ...
		 var cell0 =  row.insertCell(0);
		 cell0.innerHTML ='<table width="100%" cellpadding="0" cellspacing="0" id="nonDTSJrnyDetls'+ptJrnyTableIdlen+'"><tbody class="all1"></tbody></table>';
		 ...
		 innerHtmlValue=innerHtmlValue+'<tr class="lablevalue"><td style="width:10%;">Traveler Name</td><td style="width:10%;">Relation</td><td style="width:5%;">Age</td><td style="width:10%;">Ticket No</td><td style="width:10%;">Journey Performed?</td><td style="width:10%;">Booking Amount</td><td style="width:10%;">Refund Amount</td><td style="width:10%;">Claimed Amount</td></tr>';
		 innerHtmlValue=innerHtmlValue+'<tr class="lablevalue">';
		 innerHtmlValue=innerHtmlValue+'<td><select name="nonDTSPassDtlsTravellerName'+ptJrnyTableIdlen+'" id="nonDTSPassDtlsTravellerName'+ptJrnyTableIdlen+'_'+ptJrnyPassTableIdlen+'" class="combo" style="width:100%;" onchange="setTravellerRelationAndAge(this.value,'+ptJrnyTableIdlen+','+ptJrnyPassTableIdlen+');"><option value="">Select</option></td>';
		 ...
		 $('#nonDTSJryStartDate'+ptJrnyTableIdlen).datetimepicker({lang:'en',scrollMonth:false,timepicker:true,format:'d-m-Y H:i',formatDate:'d-m-Y H:i',maxDate:0,step:5,disabledDates:getLeaveDates(),
			                                                defaultDate:$("#start_date_time").val(),scrollInput:false,
		onShow: function () {
			  $('#nonDTSJryStartDate'+ptJrnyTableIdlen).val("");
		},onSelectDate: function(current_time,$input){validateLTCFromDate(3,ptJrnyTableIdlen);} });
		 $('#nonDTSJryEndDate'+ptJrnyTableIdlen).datetimepicker({lang:'en',scrollMonth:false,timepicker:true,format:'d-m-Y H:i',formatDate:'d-m-Y H:i',maxDate:0,step:5,disabledDates:getLeaveDates(),
			                                                defaultDate:$("#start_date_time").val(),scrollInput:false,yearEnd : 2100,
		onShow: function () {
			  $('#nonDTSJryEndDate'+ptJrnyTableIdlen).val("");
		},onSelectDate: function(current_time,$input){validateLTCToDate(3,ptJrnyTableIdlen);} });
	}
...
function addPTJrnyTraveller(index){
	...
	if(valideteNonDtsPTPassDetails(index)){
		ptJrnyPassTableIdlen++;
		 var innerHtmlValue=innerHtmlValue+'<tr class="lablevalue">';
		 innerHtmlValue=innerHtmlValue+'<td><select name="nonDTSPassDtlsTravellerName'+index+'" id="nonDTSPassDtlsTravellerName'+index+'_'+ptJrnyPassTableIdlen+'" class="combo"   style="width:100%;" onchange="setTravellerRelationAndAge(this.value,'+index+','+ptJrnyPassTableIdlen+');"><option value="">Select</option></td>';
