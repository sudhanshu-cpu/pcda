...
//	setPaoOffice();
	...
	if ('100012' == serviceId || serviceId == '100001' || serviceId == '100018') //allowing FOR APS Service
	...
	$("#editTraveler").submit(function(event) {
		event.preventDefault();
		validateUserProfile(event);
	});

});

 function setDo2Date(val){
...
function showMaritalStatus(famMaritalStatus, famMaritalStatusValue) {
	...
	if (marStausValue == famMaritalStatusValue)
		memMaritalStatusOption += '<option value="2" selected="selected">Divorced</option> ';
	else
		memMaritalStatusOption += '<option value="2">Divorced</option> ';
	...
	if (marStausValue == famMaritalStatusValue)
		memMaritalStatusOption += '<option value="3" selected="selected">Abandonment</option> ';
	else
		memMaritalStatusOption += '<option value="3">Abandonment</option> ';
	...
	if (marStausValue == famMaritalStatusValue)
		memMaritalStatusOption += '<option value="4" selected="selected">Widow</option> ';
	else
		memMaritalStatusOption += '<option value="4">Widow</option> ';
