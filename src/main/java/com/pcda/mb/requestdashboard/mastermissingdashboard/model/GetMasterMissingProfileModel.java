...
import com.pcda.mb.adduser.usermastermissdasboard.model.UserDetails;
import com.pcda.util.ApprovalState;
import com.pcda.util.PAOVerificationStatus;

import lombok.Data;
@Data
public class GetMasterMissingProfileModel {
	...
	private ApprovalState approvalStateStr;
...
private PAOVerificationStatus paoVerificationStatusStr;
	...
	private List<UserDetails> familyDetails;
