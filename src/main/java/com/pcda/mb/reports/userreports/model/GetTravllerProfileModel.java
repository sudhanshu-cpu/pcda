...
@Data
public class GetTravllerProfileModel {
	...
	private List<LevelInfoModel> levelInfo;

	private List<DependantDtls> familyDetails;

	private Boolean civilianService;
	
	private String ltcCurrentSubBlock;
	private String ltcCurSubYesNo;
    private String ltcCurrentYear;
    private String ltcCurrYrYesNo;
    private String ltcPreviousSubBlock;
    private String ltcPrevCurSubYesNo;
