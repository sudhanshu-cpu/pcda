...
import com.pcda.mb.travel.journey.model.FamilyDetailModel;
import com.pcda.mb.travel.journey.model.TravellerInfoModel;
import com.pcda.mb.travel.journey.model.YearWiseModel;
...
@Service
public class TravelInfoUtil {

	@Autowired
	private JourneyCountUtil countBizlogic;

	@Autowired
	private JourneyRequestCommonUtil trReqCommonUtil;


	public void  getCivilianTravellorFamilyDetailsForLtc(VisitorModel visitor,List<Integer> eligibleMember,String travelTypeId,TravelRule travelRule, TravellerInfoModel infoModel) 
	{
		 ...
		 List<FamilyDetailModel> familyDetail=new ArrayList<>();
		 ...
		 if(eligibleMember.contains(Integer.valueOf(0)))
		 {
			 ...
			 List<YearWiseModel> yearWise=new ArrayList<>();
		    	...
		    	yearWiseList.forEach(e->{
		    		if(isOnSuspension)
		    		{
		    			if(eligblMap.get("selfCount").intValue()!=-1){
		    				YearWiseModel model=new YearWiseModel();
		    				model.setYear(e);
		 		...
		 		familyDetailModel.setDepSeqNo(e.getSeqNumber().intValue());
				  ...
				  if(travelTypeName.contains("LTC"))
				  {
					  ...
					  yearWiseList.forEach(obj->{
						  	...
						  	{
						  		YearWiseModel yearWiseModel=new YearWiseModel();
	...
	public void  getTravellorFamilyDetailsForLtc(VisitorModel visitor,List<Integer> eligibleMember,String travelTypeId,TravelRule travelRule, TravellerInfoModel infoModel) 
	{
	...
	public void getTravellorFamilyDetailsForFormDAndGYearWise(VisitorModel visitor, List<Integer> eligibleMember, String travelTypeId, TravelRule travelRule, List<String> yearList, TravellerInfoModel infoModel) {
	...
	public void getTravellorFamilyDetails(VisitorModel visitor,List<Integer> eligibleMember,String travelTypeId,TravelRule travelRule,TravellerInfoModel infoModel) 
	{
