...
public class JourneyDetailsDTO {
	...
	public void initializeOnwardsVariable(HttpServletRequest request) {
		...
		this.setBreakJourney(Optional.ofNullable(request.getParameter("breakJourney")).orElse(""));
	...
	public void initializeReturnVariable(HttpServletRequest request) {
		...
		this.setBreakJourney(Optional.ofNullable(request.getParameter("returnBreakJourney")).orElse(""));
