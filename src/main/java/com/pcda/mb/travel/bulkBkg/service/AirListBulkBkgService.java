...
@Service
public class AirListBulkBkgService {
	...
	public List<String> getAirportList(HttpServletRequest request) {
		...
		DODLog.info(LogConstant.JOURNEY_REQUEST_LOG,AirListService.class,"[getAirportList]stationName:"+stationName+" | requestType:"+requestType);
	...
	public FlightSearchModel getAirSearchResult(HttpServletRequest request) {
		...
		DODLog.info(LogConstant.JOURNEY_REQUEST_LOG, MasterServices.class, "  journeyType  " + journeyType +" travelTypeId : " + travelTypeId +" trRule : " + trRule
				+" airViaCount " + airViaCount +" originCode " + originCode);
