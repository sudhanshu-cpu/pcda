package com.pcda.mb.finalclaim.claimrequest.util;

import com.pcda.mb.finalclaim.claimrequest.model.ClaimConyncDtlsBean;
import com.pcda.mb.finalclaim.claimrequest.model.ClaimFoodDtlsBean;
import com.pcda.mb.finalclaim.claimrequest.model.ClaimHotelDtlsBean;
import com.pcda.mb.finalclaim.claimrequest.model.ClaimJourneyDtlsBean;
import com.pcda.mb.finalclaim.claimrequest.model.ClaimLeaveDtlsBean;
import com.pcda.mb.finalclaim.claimrequest.model.ClaimNonDtsJrnyDtlsBean;
import com.pcda.mb.finalclaim.claimrequest.model.ClaimPassDtlsBean;
import com.pcda.mb.finalclaim.claimrequest.model.ClaimPersonalEffectsBean;
...
public class TADAClaimValidation {
	...
	public static String validateClaimData(ClaimRequestBean saveTADAClaimDTO){
		...
		for(ClaimJourneyDtlsBean journeyDTO: saveTADAClaimDTO.getClaimJourneyDtls()){
		...
		for(ClaimLeaveDtlsBean leavePeriodDTO:saveTADAClaimDTO.getClaimLeaveDtls()){
		...
		for(ClaimNonDtsJrnyDtlsBean nonDTSJourneyDTO:saveTADAClaimDTO.getClaimNonDtsJrnyDtls()){
...
//			}
		...
		for(ClaimHotelDtlsBean hotelDetailsDTO:saveTADAClaimDTO.getClaimHotelDtls()){
		...
		for(ClaimFoodDtlsBean foodDetailsDTO:saveTADAClaimDTO.getClaimFoodDtls()){
		...
		for(ClaimConyncDtlsBean conveyanceDetailsDTO: saveTADAClaimDTO.getClaimConyncDtls()){
	...
	public static String validateLTCClaimData(ClaimRequestBean saveTADAClaimDTO) {
		...
		for(ClaimJourneyDtlsBean journeyDTO: saveTADAClaimDTO.getClaimJourneyDtls()){
			...
			for(ClaimPassDtlsBean passengerDTO:journeyDTO.getClaimPassDtls()){
...
//				}
			...
			if(null == nonDTSJourneyDTO.getClaimedAmount()){
				resultMsg="Non DTS Journey Claimed Amount should not be Null.";
				return resultMsg;
			}
			
			for(ClaimPassDtlsBean passengerDTO:nonDTSJourneyDTO.getClaimPassDtls()){
	...
	public static String validatePTClaimData(ClaimRequestBean saveTADAClaimDTO) {
...
//		}
		...
		for(ClaimPersonalEffectsBean effectsDTO:saveTADAClaimDTO.getClaimPersonalEffectsBean()){
