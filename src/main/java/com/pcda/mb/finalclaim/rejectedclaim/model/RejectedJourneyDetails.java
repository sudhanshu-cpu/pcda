...
@Data
public class RejectedJourneyDetails implements Comparable<RejectedJourneyDetails> {
	...
	@Override
	public int compareTo(RejectedJourneyDetails o) {
		
		return this.journeyDate.compareTo(o.getJourneyDate()) ;
	}
