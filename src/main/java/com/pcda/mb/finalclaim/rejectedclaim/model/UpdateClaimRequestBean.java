...
@Data
public class UpdateClaimRequestBean {
...
//	private String advFromPAO;
		...
		public UpdateClaimRequestBean(){}

		public UpdateClaimRequestBean(HttpServletRequest request){
		...
		private List<UpdateClaimLeaveDtlsBean> setLeaveDetails(HttpServletRequest request) {
			...
			if(null!=leavePeriodDate && leavePeriodDate.length>0){
				for(int index=0;index<leavePeriodDate.length;index++){
					...
					leavePeriodDTO.setLeaveDate(CommonUtil.formatString(leavePeriodDate[index], "dd-MM-yyyy"));
