...
@Data
public class RejectedTaDaClaimDetails {
	...
	private RejectedAdvanceDtlsBean claimAdvanceDtls;
	private RejectedLeave rejectedLeave;
	private List<RejectedJourneyDetails> taDaJourneyDetails;
	private NonDtsJrny nonDtsJrny;
	private HotelDtls hotelDtls;
	private FoodDtls foodDtls;
	private ConyncDtls conyncDtls;
	private List<RejectedCertifyDtlsBean> certifyDetails;
	private List<RejectedStatusDtlsBean> statusDetails;
	private List<RejectedPersonalEffectsDtlsBean> personalEffects;
	private List<RejectedDocDtlsBean> docDetails;
